...
namespace DeadMosquito.AndroidGoodies
{
	...
	public class VideoPickResult
	{
		...
		{
			return string.Format("[VideoPickResult: OriginalPath={0}, DisplayName={1}, PreviewImagePath={2}, PreviewImageThumbnailPath={3}, PreviewImageSmallThumbnailPath={4}, Width={5}, Height={6}, Orientation={7}, Size={8}, CreatedAt={9}]", OriginalPath, DisplayName, PreviewImagePath, PreviewImageThumbnailPath, PreviewImageSmallThumbnailPath, Width, Height, Orientation, Size, CreatedAt);
		}
	}
}
#endif